classdef UnscentedKalmanFilter_IMUNodeVel < handle
...
%         L %Linearized Process Model about Noise
    ...
    methods
        function obj = UnscentedKalmanFilter_IMUNodeVel(nominalFcn,hFcns,jacobianFcns,x0,modelInfo,dT)
            ...
            obj.nY = 3*size(modelInfo.R,1) + obj.nX_pDOT + obj.nX_L; % Adjust obj.H accordingly. 
...
%             obj.Pp       	= obj.Pm;
            ...
            obj.Pm = (1e-6)^2*eye(obj.nX);
            obj.Pm(1:obj.nX_p,1:obj.nX_p) = (1e-6)^2*eye(obj.nX_p);
            obj.Pp = obj.Pm;
...
%             obj.w = A_w*obj.w;
            ...
            z(size(obj.modelInfo.R,1)*3+1:...
                size(obj.modelInfo.R,1)*3+obj.nX_pDOT) = Y.pDOT;
...
%             end
            ...
            for sample = 1:size(sigma_z,2)
                ...
                sigma_z(size(obj.modelInfo.R,1)*3+1:...
                    size(obj.modelInfo.R,1)*3+obj.nX_pDOT,...
