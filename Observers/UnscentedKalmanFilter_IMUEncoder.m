classdef UnscentedKalmanFilter_IMUEncoder < handle
...
%         L %Linearized Process Model about Noise
    ...
    methods
        function obj = UnscentedKalmanFilter_IMUEncoder(nominalFcn,hFcns,jacobianFcns,x0,modelInfo,dT)
            ...
            %18xOrientation (X,Y,Z); 24xCableEncoders  = 42-dim vector
            obj.nY = 3*size(modelInfo.R,1) + obj.nX_RL; % Adjust obj.H accordingly. 
